...
gnome-terminal -- bash -c 'gst-launch-1.0 souphttpsrc location=http://192.168.15.21:8081/video user-id=admin user-pw=admin ! jpegdec ! videoconvert ! v4l2sink device=/dev/video91; sleep 100'
